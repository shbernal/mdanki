...
import { deepMerge, getExtensionFromUrl, sanitizeString, trimArray, trimArrayEnd, trimArrayStart, } from '../src/utils.js';
describe('utils', () => {
    ...
    it('deep merges objects', () => {
        const merged = deepMerge({ a: 1, nested: { value: 1 } }, { nested: { value: 2 }, b: 3 });
