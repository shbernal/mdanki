...
export default tseslint.config(
  {
    ignores: ['dist/', 'node_modules/', '**/*.d.ts', 'resources/', '**/tsconfig*.json'],
  },
  ...typeCheckedConfigs,
  ...stylisticConfigs,
  {
    ...
    rules: {
      ...
      'import/no-extraneous-dependencies': ['error', { devDependencies: ['**/*.test.ts', '**/__tests__/**/*.ts', 'vitest.config.ts', 'eslint.config.js'] }],
      'import/order': ['warn', {
